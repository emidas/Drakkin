...
$xp = $_SESSION_Job1010['xpreward'];
$ce = $_SESSION_Name['currenergy'];
$e = $_SESSION_Job1010['ecost'];
$g = $_SESSION_Job1010['greward'];
$p = $_SESSION_Job1010['progressincrement'];
...
mysql_query("UPDATE job_110 SET progress=progress+'$p' WHERE username='$_SESSION_User'");
}
