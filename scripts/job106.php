...
$xp = $_SESSION_Job106['xpreward'];
$ce = $_SESSION_Name['currenergy'];
$e = $_SESSION_Job106['ecost'];
$g = $_SESSION_Job106['greward'];
$p = $_SESSION_Job106['progressincrement'];
...
mysql_query("UPDATE job_106 SET progress=progress+'$p' WHERE username='$_SESSION_User'");
}
