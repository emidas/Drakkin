...
$xp = $_SESSION_Job101['xpreward'];
$ce = $_SESSION_Name['currenergy'];
$e = $_SESSION_Job101['ecost'];
$g = $_SESSION_Job101['greward'];
$p = $_SESSION_Job101['progressincrement'];
...
mysql_query("UPDATE job_101 SET progress=progress+'$p' WHERE username='$_SESSION_User'");
}
