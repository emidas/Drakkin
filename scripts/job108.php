...
$xp = $_SESSION_Job108['xpreward'];
$ce = $_SESSION_Name['currenergy'];
$e = $_SESSION_Job108['ecost'];
$g = $_SESSION_Job108['greward'];
$p = $_SESSION_Job108['progressincrement'];
...
mysql_query("UPDATE job_108 SET progress=progress+'$p' WHERE username='$_SESSION_User'");
}
