...
$xp = $_SESSION_Job105['xpreward'];
$ce = $_SESSION_Name['currenergy'];
$e = $_SESSION_Job105['ecost'];
$g = $_SESSION_Job105['greward'];
$p = $_SESSION_Job105['progressincrement'];
...
mysql_query("UPDATE job_105 SET progress=progress+'$p' WHERE username='$_SESSION_User'");
}
