...
$xp = $_SESSION_Job102['xpreward'];
$ce = $_SESSION_Name['currenergy'];
$e = $_SESSION_Job102['ecost'];
$g = $_SESSION_Job102['greward'];
$p = $_SESSION_Job102['progressincrement'];
...
mysql_query("UPDATE job_102 SET progress=progress+'$p' WHERE username='$_SESSION_User'");
}
