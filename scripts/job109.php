...
$xp = $_SESSION_Job109['xpreward'];
$ce = $_SESSION_Name['currenergy'];
$e = $_SESSION_Job109['ecost'];
$g = $_SESSION_Job109['greward'];
$p = $_SESSION_Job109['progressincrement'];
...
mysql_query("UPDATE job_109 SET progress=progress+'$p' WHERE username='$_SESSION_User'");
}
