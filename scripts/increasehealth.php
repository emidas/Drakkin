...
mysql_query("UPDATE characters SET maxhealth=maxhealth+10 WHERE username='$_SESSION_User'");
mysql_query("UPDATE characters SET currhealth=currhealth+10 WHERE username='$_SESSION_User'");
