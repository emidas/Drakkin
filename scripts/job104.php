...
$xp = $_SESSION_Job104['xpreward'];
$ce = $_SESSION_Name['currenergy'];
$e = $_SESSION_Job104['ecost'];
$g = $_SESSION_Job104['greward'];
$p = $_SESSION_Job104['progressincrement'];
...
mysql_query("UPDATE job_104 SET progress=progress+'$p' WHERE username='$_SESSION_User'");
}
