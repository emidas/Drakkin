...
$xp = $_SESSION_Job103['xpreward'];
$ce = $_SESSION_Name['currenergy'];
$e = $_SESSION_Job103['ecost'];
$g = $_SESSION_Job103['greward'];
$p = $_SESSION_Job103['progressincrement'];
...
mysql_query("UPDATE job_103 SET progress=progress+'$p' WHERE username='$_SESSION_User'");
}
